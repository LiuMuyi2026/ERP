    ...
    "workflow_stages": [
        {
            ...
            "steps": [
                {"key": "classify", "label": "1. 询盘归类", "desc": "与客户沟通询盘细节，按A/B/C/D级分类告知采购员。", "owner": "业务员", "type": "checklist", "builtin": True},
                ...
                {"key": "firm_offer", "label": "4. 报实盘", "desc": "货物规格/公差/材质/价格/货源/付款方式/物流均确认后方可回复实盘。", "owner": "业务员", "type": "checklist", "builtin": True},
            ],
        },
        {
            ...
            "steps": [
                {"key": "confirm_details", "label": "1. 确认合同细节", "desc": "与客户确认买方公司名称、地址、国家、合同数量/金额、付款方式等。", "owner": "业务员、单证员", "type": "checklist", "builtin": True},
                {"key": "draft_contract", "label": "2. 起草销售合同", "desc": "单证员起草合同，业务员初审。", "owner": "单证员、业务员", "type": "file_upload", "builtin": True},
                ...
                {"key": "send_contract", "label": "5. 合同会签确认", "desc": "单证员确认合同已完成双方会签，并上传双方签字合同文件。", "owner": "单证员", "type": "file_upload", "builtin": True},
            ],
        },
        {
            "key": "procurement",
            ...
            "steps": [
                {"key": "procurement_check", "label": "1. 判定采购条件", "desc": "定金到账，或收到清洁LC正本，或收到客户签字盖章的销售合同后方可采购。", "owner": "单证员", "type": "checklist", "builtin": True},
                {"key": "confirm_supplier", "label": "2. 确认供应商", "desc": "由业务主管在供应商名录中选定供应商，告知采购经理和单证员采购意向。", "owner": "业务主管", "type": "approval", "builtin": True},
                {"key": "sign_purchase", "label": "3. 签订采购合同", "desc": "采购经理上传已签章采购合同，合同同步归档至供应商管理。", "owner": "采购经理", "type": "file_upload", "builtin": True},
        ...
        },
        {
            ...
            "steps": [
                {"key": "freight_inquiry", "label": "1. 海运询价", "desc": "在货物备妥前10-20天订舱。须比较≥2家货代的运费及港杂。", "owner": "业务员", "type": "data_input", "builtin": True},
        ...
        },
        {
            ...
            "steps": [
                {"key": "labels", "label": "1. 标签确认", "desc": "单证员制作SHIPPING MARK标签样本，业务员向客户确认。", "owner": "单证员、业务员", "type": "file_upload", "builtin": True},
                {"key": "inspection", "label": "2. 验货", "desc": "业务员决定是否出厂检验，执行检验并拍照留档。", "owner": "业务员", "type": "file_upload", "builtin": True},
                ...
                {"key": "customs", "label": "8. 报关", "desc": "单证员制作报关材料发送货代报关。", "owner": "单证员", "type": "file_upload", "builtin": True},
                {"key": "clearance_photos", "label": "9. 确认通关及照片", "desc": "确认通关情况，索要装箱/装船照片。", "owner": "业务员、单证员", "type": "file_upload", "builtin": True},
                {"key": "shipment_notice", "label": "10. 装船通知", "desc": "单证员在开船后2个工作日内制作装船通知。", "owner": "单证员", "type": "file_upload", "builtin": True},
                {"key": "documents", "label": "11. 单据制作与交单", "desc": "单证员制作全套议付单据及附件，交单后登记跟踪。", "owner": "单证员", "type": "file_upload", "builtin": True},
            ],
        },
        {
            "key": "collection",
            ...
            "steps": [
                {"key": "follow_payment", "label": "1. 跟进回款", "desc": "业务员跟进非信用证回款，单证员跟进信用证回款。", "owner": "业务员、单证员", "type": "checklist", "builtin": True},
                ...
                {"key": "filing", "label": "5. 档案归档", "desc": "所有单据和照片上传到微盘对应合同文件夹，纸质版存入档案柜。", "owner": "单证员、出纳员", "type": "file_upload", "builtin": True},
            ],
        },
    ],
    "file_categories": [
