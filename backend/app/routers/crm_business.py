"""
CRM Business Management — leads, contracts, receivables, payables, workflow,
analytics, files, communications, todos, supply chain, and risk approvals.

All API paths are preserved under /crm/* for zero frontend impact.
"""
...
from app.routers.crm_shared import (
    ...
    # Legacy default tasks
    DEFAULT_OPERATION_TASKS,
    # Models
    LeadCreate, LeadUpdate, ContractCreate, ContractUpdate,
    ReceivableCreate, ReceivableUpdate, PaymentCreate,
    PayableCreate, PayableUpdate, PayablePaymentCreate,
    ContractLineItemCreate, InteractionCreate, LeadProfileUpdate,
    LeadFileCreate, LeadFileUpdate, FilePermissionSet,
    SendEmailBody, LinkCommBody, NameDupCheck,
    ApprovalDecision,
    # Utilities
